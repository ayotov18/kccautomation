...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Schedule & Cost', path: '/schedule', icon: <Gauge size={16} strokeWidth={1.75} /> },
    ],
  },
  {
    title: 'Reports',
    items: [
      ...
      { label: 'BoQ Editor', path: '/boq', icon: <Table2 size={16} strokeWidth={1.75} /> },
      { label: 'Tendering', path: '/tendering', icon: <Handshake size={16} strokeWidth={1.75} /> },
  ...
  },
  {
    title: 'Data',
    items: [
      { label: 'Cost Database', path: '/costs', icon: <Database size={16} strokeWidth={1.75} /> },
      { label: 'Assemblies', path: '/assemblies', icon: <Layers size={16} strokeWidth={1.75} /> },
      { label: 'Price Management', path: '/prices', icon: <Tag size={16} strokeWidth={1.75} /> },

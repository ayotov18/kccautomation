...
const ROUTES: Route[] = [
  ...
  { id: 'schedule', label: 'Schedule & Cost', labelBg: 'График и цена', path: '/schedule', group: 'Работа', icon: <Gauge size={14} />, keywords: ['4d', '5d', 'график', 'цена'] },
  ...
  { id: 'boq', label: 'BoQ Editor', labelBg: 'BoQ редактор', path: '/boq', group: 'Отчети', icon: <Table2 size={14} />, keywords: ['bill', 'quantities'] },
  { id: 'tendering', label: 'Tendering', labelBg: 'Тръжни документи', path: '/tendering', group: 'Отчети', icon: <Handshake size={14} />, keywords: ['тендер', 'търг'] },
  { id: 'validation', label: 'Validation', labelBg: 'Валидация', path: '/validation', group: 'Отчети', icon: <ShieldCheck size={14} />, keywords: ['проверка'] },
  { id: 'costs', label: 'Cost Database', labelBg: 'Ценова база', path: '/costs', group: 'Данни', icon: <Database size={14} />, keywords: ['цени', 'database'] },
  { id: 'assemblies', label: 'Assemblies', labelBg: 'Сглобки', path: '/assemblies', group: 'Данни', icon: <Layers size={14} />, keywords: ['assembly'] },
  { id: 'prices', label: 'Price Management', labelBg: 'Управление на цени', path: '/prices', group: 'Данни', icon: <Tag size={14} />, keywords: ['цени', 'market'] },
